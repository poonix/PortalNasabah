...
public class RekeningDebiturModel extends BaseModel implements Parcelable {
    ...
    public RekeningDebiturModel() {

    }

    protected RekeningDebiturModel(Parcel in) {
    ...
    public static final Creator<RekeningDebiturModel> CREATOR = new Creator<RekeningDebiturModel>() {
        @Override
        public RekeningDebiturModel createFromParcel(Parcel in) {
            return new RekeningDebiturModel(in);
        }

        @Override
        public RekeningDebiturModel[] newArray(int size) {
            return new RekeningDebiturModel[size];
        }
    };
